...
def get_air_quality(town) -> None:

    place = town_to_lat_long(town)
...
if __name__ == "__main__":
    r = http_query("era5_land_wind_u-hourly", "25.762329613614614", "-80.19114735100034")
    get_air_quality("Miami")